...
uint256 hashGenesisBlock("0xdc901462c64d401043375bf6f1f52d5757e3ab04f1d8c9f5a2ab2f49b02ab413");
...
const string strMessageMagic = "WorldTopCoin Signed Message:\n";
...
{
    int64 nSubsidy = COIN_PER_BLOCK * COIN; //TODO coins per block

    // Subsidy is cut in half every 1440 blocks, which will occur approximately every day
    nSubsidy >>= (nHeight / BLOCK_COUNTS_TO_CUT_HALF);
...
static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; //TODO WorldTopCoin: 3.5 days
static const int64 nTargetSpacing = 1 * 60; //TODO WorldTopCoin: 1 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // WorldTopCoin difficulty adjustment protocol switch
    ...
    // WorldTopCoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal WorldTopCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "WorldTopCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "NY Times 02/Dec/2013 David Cameron, Prime Minister of the UK ,makes up to China";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1386293400;    //12 / 06 / 2013 @ 1:30:0 UTC   http://www.unixtimestamp.com/index.php
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084524493;

        if (fTestNet)
        {
            block.nTime    = 1386293400;
        ...
        assert(block.hashMerkleRoot == uint256("0x43c38d5b35b7c4b7733751a5ecfd7cbc33bb8d95166270c522421b853207f098"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // WorldTopCoin: increase each by adding 2 to bitcoin's value.
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // WorldTopCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
